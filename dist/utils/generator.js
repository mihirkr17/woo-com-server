...
module.exports.generateOrderID = (id) => ("oi_" + cryptoGraphy.randomBytes(16).toString('hex').slice(0, 16) + id.slice(0, 4));
...
module.exports.generateSupplierDataToken = (supplier) => {
