...
module.exports.updateCartProductQuantityController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { productID, variationID, cartID, quantity } = (_e = (_d = req === null || req === void 0 ? void 0 : req.body) === null || _d === void 0 ? void 0 : _d.upsertRequest) === null || _e === void 0 ? void 0 : _e.cartContext;
