...
module.exports.addToCartHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let existsProduct = yield ShoppingCart.findOne({ $and: [{ customerId: ObjectId(_id) }, { sku }, { productId: ObjectId(productId) }] });
        if (existsProduct)
            return res.status(200).send({ success: true, statusCode: 200, message: "This product already in your cart." });
...
module.exports.updateCartProductQuantityController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (cacheProduct) {
            Array.isArray(cacheProduct) && cacheProduct.forEach((item) => {
...
module.exports.deleteCartItem = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let deleted = yield ShoppingCart.findOneAndDelete({ $and: [{ customerId: ObjectId(_id) }, { productId: ObjectId(productID) }, { sku }] });
        if (!deleted)
