...
module.exports.supplierRegistrationController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let existUser = yield Supplier.countDocuments({
            $or: [{ email }, { phone }],
        });
        if (existUser >= 1) {
        ...
        return res.status(200).send({
            ...
            statusCode: 200,
            returnEmail: email,
            message: "Thanks for your information. Verification code was sent to " +
                email +
...
module.exports.supplierLoginController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!email || !cPwd)
            throw new Api400Error("Required email and password !");
        let supplier = yield Supplier.findOne({ email }, { createdAt: 0, __v: 0 });
        ...
        const matchedPwd = yield supplier.comparePassword(cPwd);
        if (!matchedPwd)
