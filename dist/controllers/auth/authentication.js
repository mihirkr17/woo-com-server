...
module.exports.loginController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (token) {
            ...
            res.cookie("_uuid", existUser === null || existUser === void 0 ? void 0 : existUser._uuid, { httpOnly: false, sameSite: "none", secure: true, maxAge: 57600000, domain: 'wookart.vercel.app', path: "/" });
