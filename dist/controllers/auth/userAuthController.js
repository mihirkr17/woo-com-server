 ...
 * @apiRequired --> BODY
 */
module.exports.userRegistrationController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let body = req.body;
        ...
        const emailResult = yield email_service({
 ...
 * @apiRequired --> BODY
 */
module.exports.userLoginController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
module.exports.userAccountVerifyByEmail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
module.exports.generateNewVerifyToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
