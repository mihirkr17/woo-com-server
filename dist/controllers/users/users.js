...
module.exports.fetchAuthUserController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (result && (result === null || result === void 0 ? void 0 : result.role) === 'SELLER') {
            const cpbs = yield productCounter({ storeName: (_d = result.seller.storeInfos) === null || _d === void 0 ? void 0 : _d.storeName, _UUID: result === null || result === void 0 ? void 0 : result._UUID });
            if (cpbs && typeof cpbs === 'object') {
                result.seller.storeInfos.numOfProducts = cpbs === null || cpbs === void 0 ? void 0 : cpbs.totalProducts;
                result.seller.storeInfos.productInFulfilled = cpbs === null || cpbs === void 0 ? void 0 : cpbs.productInFulfilled;
                result.seller.storeInfos.productInDraft = cpbs === null || cpbs === void 0 ? void 0 : cpbs.productInDraft;
            }
        }
