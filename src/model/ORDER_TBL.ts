...
const orderItemsSchema = new Schema({
  ...
  supplierId: { type: Schema.Types.ObjectId, required: true, ref: "SUPPLIER_TBL" },
...
const ORDER_TABLE = model("ORDER_TBL", orderSchema, "ORDER_TBL");
const ORDER_ITEMS_TABLE = model(
  "ORDER_ITEMS_TBL",
  orderItemsSchema,
  "ORDER_ITEMS_TBL"
);
