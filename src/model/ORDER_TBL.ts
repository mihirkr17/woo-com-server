...
const orderItemsSchema = new Schema({
  orderId: { type: Schema.Types.ObjectId, required: true, ref: "ORDER_TBL" },

  trackingId: { type: String },

  productId: { type: Schema.Types.ObjectId, required: true },

  storeId: { type: Schema.Types.ObjectId, required: true, ref: "STORE_TBL" },
...
const Order = model("ORDER_TBL", orderSchema, "ORDER_TBL");
const OrderItems = model(
  "ORDER_ITEMS_TBL",
  orderItemsSchema,
  "ORDER_ITEMS_TBL"
);
...
// Main Order Table
const ORDER_TABLE_SCHEMA = new Schema({
  customerId: { type: Schema.Types.ObjectId, ref: "CUSTOMER_TBL" },
  ...
  storeId: { type: Schema.Types.ObjectId, ref: "STORE_TBL" },
...
// order items schema
const ORDER_ITEM_TABLE_SCHEMA = new Schema({
  orderId: {
    type: Schema.Types.ObjectId,
    ref: "ORDER_TBL",
